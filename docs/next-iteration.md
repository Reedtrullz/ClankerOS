...
- Packet ID: iteration_05aea0a6c989
- Status: planned
- Source: tasks.md#next

## Objective

Advance the Agent System north-star goal by completing: Make post-coder-prep `/today` expose `Create worktree plan` as the primary same-page first-run action with confirmation and finish-today resume proof.
