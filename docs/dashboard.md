...
- status: planned
- focus: Make successor Goal commit requests from `/today` and `/resume` consume `runs/<source_run_id>/review.md` as proof, keep provenance history visible, and move the primary action to `Approve commit`.
- source: tasks.md#next
- packet: docs/next-iteration.md
- created_at: 2026-07-06T06:48:35.748623+00:00
...
- selected_focus: Make successor Goal commit requests from `/today` and `/resume` consume `runs/<source_run_id>/review.md` as proof, keep provenance history visible, and move the primary action to `Approve commit`.
