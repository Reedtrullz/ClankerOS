...
- status: planned
- focus: Make post-completion `/today` and `/resume` expose completed Goal evidence plus a clear next-Goal/start-new-work action without losing the saved daily resume proof.
- source: tasks.md#next
- packet: docs/next-iteration.md
- created_at: 2026-07-06T01:55:29.089775+00:00
...
- selected_focus: Make post-completion `/today` and `/resume` expose completed Goal evidence plus a clear next-Goal/start-new-work action without losing the saved daily resume proof.
