...
- status: planned
- focus: Make successor Goal worktree reviews from `/today` and `/resume` consume approved worktree run evidence as proof, keep provenance history visible, and move the primary action to `Create commit request`.
- source: tasks.md#next
- packet: docs/next-iteration.md
- created_at: 2026-07-06T06:26:47.120567+00:00
...
- selected_focus: Make successor Goal worktree reviews from `/today` and `/resume` consume approved worktree run evidence as proof, keep provenance history visible, and move the primary action to `Create commit request`.
