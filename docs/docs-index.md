...
Use this as the human map. Generated reports are useful evidence, but the
tutorials and operating docs are the better place to start.
...
- `WORKFLOW.md` - lifecycle ordering from goal intake through verification,
  evidence, approvals, delegation packets, and dashboard visibility.

## Tutorials

- `docs/tutorial-first-loop.md` - initialize and run the first local loop.
- `docs/tutorial-approval-gated-coding.md` - worktree-isolated coding with
  evidence, approval, commit, GitHub handoff, and cleanup.
- `docs/tutorial-subagent-delegation-results.md` - profile routing, read-only
  delegation packets, and structured result ingestion.
- `docs/tutorial-skill-proposals.md` - propose and approve reusable skills
  from verified run evidence.
- `docs/tutorial-run-review.md` - review, evidence index, and replay summary
  packets for completed runs.
- `docs/tutorial-steering-inbox.md` - steering reviews, next-action output,
  and the local inbox.
- `docs/tutorial-operator-approval-schema.md` - approved local schema crossing
  for `operator_approval_requests`.
- `docs/tutorial-operator-approval-effect-proposals.md` - operator approval
  effects and activation tasks.
- `docs/tutorial-capability-activation-contracts.md` - blocked evidence and
  approval contracts for capability activation tasks.
- `docs/tutorial-capability-followup-result-decisions.md` - review ingested
  follow-up results while keeping activation blocked.
- `docs/tutorial-capability-followup-result-effect-proposals.md` - create
  proposed effects from accepted blocked follow-up decisions.
- `docs/tutorial-capability-followup-result-effect-application.md` - apply
  accepted blocked follow-up result effects as local records.
- `docs/tutorial-capability-followup-result-tasks.md` - materialize applied
  follow-up result effects into downstream proof tasks.
- `docs/tutorial-capability-followup-result-task-delegations.md` - route
  downstream proof tasks to read-only evaluator delegation packets.
- `docs/tutorial-capability-followup-result-task-results.md` - ingest
...
- `docs/tutorial-capability-followup-result-task-result-effect-proposals.md` -
  create proposed effects from accepted downstream proof-plan result decisions.
- `docs/tutorial-capability-followup-result-task-result-effect-application.md`
  - apply accepted downstream proof-plan result decision effects locally.
...
- `docs/tutorial-capability-followup-result-task-result-effect-task-decisions.md`
  - review downstream result effect task result records while keeping
  activation blocked.
...
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-application.md`
  - apply proposed downstream result effect task result decision effects
  locally.
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-tasks.md`
  - materialize applied downstream result effect task result decision effects
...
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-delegations.md`
  - route downstream result effect task result effect tasks to read-only
...
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-results.md`
  - ingest completed downstream result effect task result effect delegation
  outputs as local result records.
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-decisions.md`
  - review downstream result effect task result effect result records while
...
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-result-effect-task-result-effect-application.md`
  - apply proposed downstream result effect task result effect task result
    effect task result decision effects as local records.
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-result-effect-task-result-effect-tasks.md`
  - materialize applied downstream result effect task result effect task result
...
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-result-effect-task-result-effect-task-delegations.md`
  - route downstream result effect task result effect task result effect task
    result effect tasks to read-only evaluator delegation packets.
- `docs/tutorial-capability-followup-result-task-result-effect-task-result-effect-task-result-effect-task-result-effect-task-results.md`
  - ingest completed downstream result effect task result effect task result
    effect task result effect delegation outputs into local result records.
...
These files are generated by CLI commands and should be read as evidence
packets, not as marketing docs:
...
For public snapshots, use `docs/suggested-use.md#when-to-commit-and-push` as
the baseline: commit only coherent, verified increments; push only after the
branch target and remote are explicit. Pushing is not deployment, and local
tests are not CI proof unless CI was actually checked.
