# Tutorial: Capability Follow-Up Result Task Result Effect Task Result Effect Task Result Effect Task Result Effect Task Result Effect Task Result Effect Proposals
...
effect task result records. It creates local proposed effects only; it does
