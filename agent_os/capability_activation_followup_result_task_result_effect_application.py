...
APPLICATION_NO_APPLICABLE_PROPOSALS = (
    "capability_activation_followup_result_task_result_effect_application_no_applicable_proposals"
)
REPORT_PATH = (
...
def apply_capability_activation_followup_result_task_result_effects(
    root: Path,
    *,
    operator_id: str,
    selection_note: str,
    ...
    application = (
        storage.record_capability_activation_followup_result_task_result_effect_application(
            status=status,
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_effect_application_report(
            application,
            proposed_effects,
            applied_effects,
            existing_applied_effects,
...
def render_capability_activation_followup_result_task_result_effect_application_line(
    application: CapabilityActivationFollowupResultTaskResultEffectApplication,
) -> str:
    return (
...
def render_capability_activation_followup_result_task_result_effect_application_report(
    application: CapabilityActivationFollowupResultTaskResultEffectApplication,
