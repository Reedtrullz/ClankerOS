...
class CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectProposalSummary:
    status: str
...
def write_capability_activation_followup_result_task_result_effect_task_result_effect_proposals(
    root: Path,
) -> tuple[
    Path,
    CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectProposalSummary,
    list[Effect],
]:
    root = root.resolve()
    ...
    existing_effects = _capability_followup_task_result_effect_task_result_decision_effects(
        storage
    )
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_effect_task_result_effect_proposals_report(
            summary,
            accepted_pairs,
            created_effects,
            existing_effects,
...
def render_capability_activation_followup_result_task_result_effect_task_result_effect_proposal_line(
    effect: Effect,
) -> str:
...
def render_capability_activation_followup_result_task_result_effect_task_result_effect_proposals_report(
    summary: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectProposalSummary,
    accepted_pairs: list[
        tuple[
            CapabilityActivationFollowupResultTaskResultEffectTaskResultDecision,
            CapabilityActivationFollowupResultTaskResultEffectTaskResultRecord,
...
def _accepted_decision_result_pairs(
    ...
    result_records_by_id = {
        record.id: record
        for record in storage.list_capability_activation_followup_result_task_result_effect_task_result_records()
    }
    pairs = []
    for decision in (
...
def _capability_followup_task_result_effect_task_result_decision_effects(
    storage: Storage,
) -> list[Effect]:
...
def _idempotency_key(
    decision: CapabilityActivationFollowupResultTaskResultEffectTaskResultDecision,
    result_record: CapabilityActivationFollowupResultTaskResultEffectTaskResultRecord,
) -> str:
...
def _payload_for_result(
    ...
    return {
        ...
        "source_application_decision_id": result_record.source_decision_id,
        "source_application_downstream_result_id": (
            result_record.source_downstream_result_id
        ),
        "source_effect_id": result_record.source_effect_id,
        "source_delegation_id": result_record.source_delegation_id,
...
def _render_accepted_result_line(
    decision: CapabilityActivationFollowupResultTaskResultEffectTaskResultDecision,
    record: CapabilityActivationFollowupResultTaskResultEffectTaskResultRecord,
) -> str:
    return (
        ...
        f"source_application_decision={record.source_decision_id} "
