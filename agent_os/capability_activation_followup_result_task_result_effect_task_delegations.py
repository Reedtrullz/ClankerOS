...
def write_capability_activation_followup_result_task_result_effect_task_delegations(
    root: Path,
) -> tuple[
    Path,
    CapabilityActivationFollowupResultTaskResultEffectTaskDelegationBatch,
    ...
    batch = storage.record_capability_activation_followup_result_task_result_effect_task_delegation_batch(
        status=status,
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_effect_task_delegations_report(
            batch,
            created_delegations,
...
def render_capability_activation_followup_result_task_result_effect_task_delegation_batch_line(
    batch: CapabilityActivationFollowupResultTaskResultEffectTaskDelegationBatch,
) -> str:
    return (
...
def render_capability_activation_followup_result_task_result_effect_task_delegations_report(
    batch: CapabilityActivationFollowupResultTaskResultEffectTaskDelegationBatch,
    created_delegations: list[SubagentDelegation],
...
def _delegation_title(task: Task) -> str:
    ...
    return f"Plan next downstream proof evidence for {capability}"
...
def _render_task_line(task: Task) -> str:
    return (
        ...
        f"upstream_followup_result={task.evidence.get('source_followup_result_id')} "
