...
DECISIONS_RECORDED = (
    "capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions_recorded"
)
...
DECISIONS_NO_RESULTS = (
    "capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions_no_results"
)
REPORT_PATH = (
...
def decide_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_results(
    root: Path,
    *,
    operator_id: str,
    selected_action: str,
    ...
    result_records = (
        storage.list_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_records()
    )
    ...
    decision = storage.record_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decision(
        status=status,
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decision_report(
            decision,
            report_records,
        ),
        encoding="utf-8",
...
def render_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decision_line(
...
def render_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decision_report(
    decision: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultEffectTaskResultDecision,
