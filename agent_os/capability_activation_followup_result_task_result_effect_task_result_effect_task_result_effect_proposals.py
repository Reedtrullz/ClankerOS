...
class CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultEffectProposalSummary:
    status: str
...
def write_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_proposals(
    root: Path,
) -> tuple[
    Path,
    CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultEffectProposalSummary,
    list[Effect],
]:
    root = root.resolve()
    ...
    existing_effects = _capability_followup_task_result_effect_task_result_effect_task_result_decision_effects(
        storage
    )
            ...
            storage.record_effect(
                ...
                compensation_plan={
                    ...
                    "reason": (
                        ...
                        "effect_blocked_activation_preserved"
                    ),
                },
                result_json={
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_proposals_report(
            summary,
            accepted_pairs,
            created_effects,
            existing_effects,
...
def render_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_proposal_line(
    effect: Effect,
) -> str:
...
def render_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_proposals_report(
    summary: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultEffectProposalSummary,
    accepted_pairs: list[
        tuple[
            CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultDecision,
            CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultRecord,
...
def _accepted_decision_result_pairs(
    ...
    result_records_by_id = {
        record.id: record
        for record in storage.list_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_records()
    }
    pairs = []
    for decision in (
...
def _capability_followup_task_result_effect_task_result_effect_task_result_decision_effects(
    storage: Storage,
) -> list[Effect]:
...
def _idempotency_key(
    decision: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultDecision,
    result_record: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultRecord,
) -> str:
...
def _payload_for_result(
    ...
    return {
        ...
        "upstream_source_delegation_id": result_record.source_application_delegation_id,
...
def _render_accepted_result_line(
    decision: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultDecision,
    record: CapabilityActivationFollowupResultTaskResultEffectTaskResultEffectTaskResultRecord,
) -> str:
    return (
