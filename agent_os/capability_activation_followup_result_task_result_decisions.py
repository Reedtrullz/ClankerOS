...
REPORT_PATH = "docs/capability-activation-followup-result-task-decisions.md"


def decide_capability_activation_followup_result_task_results(
    root: Path,
    *,
    operator_id: str,
    selected_action: str,
    ...
    result_records = (
        storage.list_capability_activation_followup_result_task_result_records()
    )
    ...
    decision = (
        storage.record_capability_activation_followup_result_task_result_decision(
            status=status,
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_decision_report(
            decision,
            ready_records,
        ),
        encoding="utf-8",
...
def render_capability_activation_followup_result_task_result_decision_line(
...
def render_capability_activation_followup_result_task_result_decision_report(
    decision: CapabilityActivationFollowupResultTaskResultDecision,
    decided_records: list[CapabilityActivationFollowupResultTaskResultRecord],
) -> str:
    lines = [
...
def _already_decided_result_ids(
    storage: Storage,
    result_records: list[CapabilityActivationFollowupResultTaskResultRecord],
) -> set[str]:
