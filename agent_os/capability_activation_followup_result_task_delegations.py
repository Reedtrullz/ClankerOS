...
def write_capability_activation_followup_result_task_delegations(
    root: Path,
) -> tuple[
    Path,
    CapabilityActivationFollowupResultTaskDelegationBatch,
    ...
    batch = storage.record_capability_activation_followup_result_task_delegation_batch(
        status=status,
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_delegations_report(
            batch,
            created_delegations,
...
def render_capability_activation_followup_result_task_delegation_batch_line(
    batch: CapabilityActivationFollowupResultTaskDelegationBatch,
) -> str:
    return (
...
def render_capability_activation_followup_result_task_delegations_report(
    batch: CapabilityActivationFollowupResultTaskDelegationBatch,
    created_delegations: list[SubagentDelegation],
...
def _delegation_title(task: Task) -> str:
    ...
    return f"Plan next proof evidence for {capability}"
...
def _render_task_line(task: Task) -> str:
    return (
        ...
        f"source_delegation={task.evidence.get('source_delegation_id')} "
