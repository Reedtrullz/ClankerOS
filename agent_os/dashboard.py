...
from agent_os.capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_proposals import (
    ...
    REPORT_PATH as CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH,
...
from agent_os.capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_proposals import (
    ...
    REPORT_PATH as CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH,
...
from agent_os.capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_proposals import (
    ...
    REPORT_PATH as CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH,
...
from agent_os.capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_proposals import (
    ...
    REPORT_PATH as CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH,
...
from agent_os.capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_proposals import (
    ...
    REPORT_PATH as CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH,
...
from agent_os.capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_proposals import (
    ...
    REPORT_PATH as CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH,
...
def generate_static_dashboard(root: Path) -> Path:
    ...
    with sqlite3.connect(db_path) as connection:
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_record_batches = []
        if _table_exists(
            connection,
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_record_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_batches = (
                storage.list_recent_capability_activation_followup_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_applications = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_applications(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions(
                    limit=None
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions(
                    limit=None
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_decisions = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_decisions(
                    limit=None
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_effect_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_effect_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_delegation_batches = (
                storage.list_recent_capability_activation_followup_result_task_delegation_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_batches = (
                storage.list_recent_capability_activation_followup_result_task_result_batches(
                    limit=1
                )
            )
        ...
        if _table_exists(
            ...
            capability_activation_followup_result_task_result_decisions = (
                storage.list_recent_capability_activation_followup_result_task_result_decisions(
                    limit=1
                )
            )
    ...
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_application = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_applications[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_applications
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_application = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_application = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_application = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_application = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_application = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_applications
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_record_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_record_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_record_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decision = (
        next(
            (
                decision
                for decision in capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
                if decision.decision_count > 0
            ),
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions[
                0
            ],
    ...
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decision = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batch = (
        ...
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decision = (
        next(
            (
                decision
                for decision in capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
                if decision.decision_count > 0
            ),
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions[
                0
        ...
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decision = (
        next(
            (
                decision
                for decision in capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
                if decision.decision_count > 0
            ),
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions[
                0
        ...
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decision = (
        next(
            (
                decision
                for decision in capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
                if decision.decision_count > 0
            ),
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions[
                0
        ...
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_decisions
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_effect_task_result_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_effect_task_result_decision = (
        next(
            (
                decision
                for decision in capability_activation_followup_result_task_result_effect_task_result_effect_task_result_decisions
                if decision.decision_count > 0
            ),
            capability_activation_followup_result_task_result_effect_task_result_effect_task_result_decisions[
                0
        ...
        if capability_activation_followup_result_task_result_effect_task_result_effect_task_result_decisions
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_batch = (
        capability_activation_followup_result_task_result_effect_task_batches[0]
        if capability_activation_followup_result_task_result_effect_task_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_delegation_batch = (
        capability_activation_followup_result_task_result_effect_task_delegation_batches[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_batch = (
        capability_activation_followup_result_task_result_effect_task_result_batches[0]
        if capability_activation_followup_result_task_result_effect_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_effect_task_result_decision = (
        capability_activation_followup_result_task_result_effect_task_result_decisions[
            0
        ]
        if capability_activation_followup_result_task_result_effect_task_result_decisions
        else None
    )
    ...
    latest_capability_activation_followup_result_task_delegation_batch = (
        capability_activation_followup_result_task_delegation_batches[0]
        if capability_activation_followup_result_task_delegation_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_batch = (
        capability_activation_followup_result_task_result_batches[0]
        if capability_activation_followup_result_task_result_batches
        else None
    )
    latest_capability_activation_followup_result_task_result_decision = (
        capability_activation_followup_result_task_result_decisions[0]
        if capability_activation_followup_result_task_result_decisions
        else None
    )
    ...
    if (
        ...
        lines.extend(
            [
                (
                    "- status: "
                    "capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_proposals_recorded"
                ),
                ...
                (
                    "- report: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH}"
                ),
                "",
            ]
        )
    ...
    if latest_capability_activation_followup_result_batch is not None:
        batch = latest_capability_activation_followup_result_batch
        lines.extend(
            [
                f"- status: {batch.status}",
                f"- completed_delegations: {batch.completed_delegation_count}",
    ...
    if capability_activation_followup_result_effect_proposals:
        latest_effect = capability_activation_followup_result_effect_proposals[0]
        lines.extend(
            [
                ...
                (
                    "- accepted_decisions: "
                    f"{len({effect.run_id for effect in capability_activation_followup_result_effect_proposals})}"
                ),
                (
                    "- accepted_results: "
                    f"{len(capability_activation_followup_result_effect_proposals)}"
                ),
                (
        ...
        lines.extend(
            render_capability_activation_followup_result_effect_proposal_line(effect)
            for effect in capability_activation_followup_result_effect_proposals
        )
    else:
        lines.append("- none")
    ...
    if latest_capability_activation_followup_result_effect_application is not None:
        application = latest_capability_activation_followup_result_effect_application
        lines.extend(
            [
                f"- status: {application.status}",
                f"- operator_id: {application.operator_id}",
    ...
    if latest_capability_activation_followup_result_task_delegation_batch is not None:
        batch = latest_capability_activation_followup_result_task_delegation_batch
        lines.extend(
            [
                f"- status: {batch.status}",
                f"- downstream_tasks: {batch.downstream_task_count}",
    ...
    if latest_capability_activation_followup_result_task_result_batch is not None:
        batch = latest_capability_activation_followup_result_task_result_batch
        lines.extend(
            [
                f"- status: {batch.status}",
                f"- completed_delegations: {batch.completed_delegation_count}",
    ...
    if latest_capability_activation_followup_result_task_result_decision is not None:
        decision = latest_capability_activation_followup_result_task_result_decision
        lines.extend(
            [
                f"- status: {decision.status}",
                f"- selected_action: {decision.selected_action}",
    ...
    if (
        ...
        batch = latest_capability_activation_followup_result_task_result_effect_task_batch
        lines.extend(
            [
                f"- status: {batch.status}",
                f"- source_application: {batch.source_application_id}",
        ...
        lines.extend(
            [
                ...
                (
                    ...
                    f"{batch.routing_decision_count}"
                ),
                f"- delegations_created: {batch.delegation_count}",
                f"- existing_delegations: {batch.existing_delegation_count}",
                f"- execution_started: {batch.execution_started_count}",
    ...
    if (
        ...
        lines.extend(
            [
                (
                    "- status: "
                    "capability_activation_followup_result_task_result_effect_task_result_effect_task_result_effect_task_result_effect_proposals_recorded"
                ),
                f"- source_decision: {latest_effect.run_id}",
                (
                    "- accepted_decisions: "
                ...
                (
                    "- report: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH}"
                ),
                "",
            ]
        )
    ...
    if (
        ...
        lines.extend(
            [
                (
                    "- status: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_PROPOSALS_RECORDED}"
                ),
                f"- source_decision: {latest_effect.run_id}",
                f"- effect_proposals_created: {len(proposal_effects)}",
                f"- latest_effect: {latest_effect.id}",
                (
                    "- report: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH}"
                ),
                "",
            ]
        )
        lines.extend(
            ...
            for effect in proposal_effects[:5]
        )
    else:
        lines.append("- none")
    ...
    if (
        ...
        lines.extend(
            [
                (
                    "- status: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_PROPOSALS_RECORDED}"
                ),
                f"- source_decision: {latest_effect.run_id}",
                f"- effect_proposals_created: {len(proposal_effects)}",
                f"- existing_effect_proposals: {len(proposal_effects)}",
                ...
                (
                    "- report: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH}"
                ),
                "",
            ]
        )
    ...
    if (
        ...
        lines.extend(
            [
                (
                    "- status: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_PROPOSALS_RECORDED}"
                ),
                f"- source_decision: {latest_effect.run_id}",
                f"- effect_proposals_created: {len(proposal_effects)}",
                f"- existing_effect_proposals: {len(proposal_effects)}",
                ...
                (
                    "- report: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH}"
                ),
                "",
            ]
        )
    ...
    if (
        ...
        lines.extend(
            [
                (
                    "- status: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_PROPOSALS_RECORDED}"
                ),
                f"- source_decision: {latest_effect.run_id}",
                f"- effect_proposals_created: {len(proposal_effects)}",
                f"- existing_effect_proposals: {len(proposal_effects)}",
                ...
                (
                    "- report: "
                    f"{CAPABILITY_FOLLOWUP_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_EFFECT_TASK_RESULT_DECISION_EFFECT_REPORT_PATH}"
                ),
                "",
            ]
        )
