...
def decide_capability_activation_followup_result_task_result_effect_task_results(
    root: Path,
    *,
    operator_id: str,
    selected_action: str,
    ...
    decision = storage.record_capability_activation_followup_result_task_result_effect_task_result_decision(
        status=status,
    ...
    report_path.write_text(
        render_capability_activation_followup_result_task_result_effect_task_result_decision_report(
            decision,
            ready_records,
        ),
        encoding="utf-8",
...
def render_capability_activation_followup_result_task_result_effect_task_result_decision_line(
...
def render_capability_activation_followup_result_task_result_effect_task_result_decision_report(
    decision: CapabilityActivationFollowupResultTaskResultEffectTaskResultDecision,
